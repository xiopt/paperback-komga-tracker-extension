...
exports.PaperbackInfo = {
    ...
    intents: types_1.SourceIntents.MANGA_CHAPTERS |
        ...
        types_1.SourceIntents.MANGA_TRACKING,
};
...
class KomgaRequestInterceptor {
    ...
    interceptRequest(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = request === null || request === void 0 ? void 0 : request.headers) === null || _a === void 0 ? void 0 : _a.authorization) == null) {
                ...
                onSubmit: (values) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    for (const book of result.content) {
                        if (book.metadata.numberSort <= values['progress']) {
                            ...
                            yield this.requestManager.schedule(request, 1);
                        }
                    }
                    return;
                }),
...
},{"./Common":63,"./Languages":64,"./Settings":66,"@paperback/types":59}],66:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
